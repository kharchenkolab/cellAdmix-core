...
cell's content is essentially its own; at the acinar interface, the
same kind of cell is flooded with exocrine-owned molecules (red)
physically transferred from the acinar cells around it:

```{r anatomy-molecules, fig.width=10, fig.height=4.8}
...
markers and the induced genes light up together — indistinguishable to
a naive neighborhood analysis. After, the transferred markers collapse
toward zero fold change while the induced program keeps its shift:

```{r volcano, fig.width=11, fig.height=4.8}
