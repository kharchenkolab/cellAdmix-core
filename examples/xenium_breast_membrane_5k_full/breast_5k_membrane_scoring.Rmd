...
bundle_dir <- "data"
output_dir <- "out"
nmf_variant <- Sys.getenv("CELLADMIX_NMF_VARIANT", "invsqrt_kl")
...
gene-loading molecule scoring. To render a comparison with another variant,
set `CELLADMIX_NMF_VARIANT` before executing the notebook.
...
admixture sources membrane scoring covers well — epithelial cells (which
...
rule for — most prominently epithelial leakage into endothelial and
fibroblast cells. Membrane scoring depends on stain-path contrast along
