...
fibroblast cells, exactly the diagnostic targets whose volcano plots
barely move. Membrane scoring depends on stain-path contrast along
...
head(bridge_rules[bridge_rules$keep &
  bridge_rules$target_cell_type %in% diagnostic_cell_types,
