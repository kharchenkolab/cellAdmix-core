...
## Bridge Scoring for Stain-Weak Targets
...
The audit verifies the bridge correction against the same measurements,
and the side-by-side comparison shows what each method removes:
...
The diagnostic volcano and p-value shift plots now show the improvement
membrane scoring could not deliver for these targets:
